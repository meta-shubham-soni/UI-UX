    ...
    function Pass() {
        ...
        this.convertPricesTo = function (btnId, currency, currenyValue) {
            ...
            if (btnId != undefined && (btn === null || btn === void 0 ? void 0 : btn.id) != currentSelected.id) {
                ...
                newPrices.Cycle.daily = parseFloat((_this.packages.Cycle.daily * currenyValue).toFixed(1));
                newPrices.Cycle.Monthly = parseFloat((_this.packages.Cycle.Monthly * currenyValue).toFixed(1));
                newPrices.Cycle.yearly = parseFloat((_this.packages.Cycle.yearly * currenyValue).toFixed(1));
                newPrices.bike.daily = parseFloat((_this.packages.bike.daily * currenyValue).toFixed(1));
                newPrices.bike.Monthly = parseFloat((_this.packages.bike.Monthly * currenyValue).toFixed(1));
                newPrices.bike.yearly = parseFloat((_this.packages.bike.yearly * currenyValue).toFixed(1));
                newPrices.car.daily = parseFloat((_this.packages.car.daily * currenyValue).toFixed(1));
                newPrices.car.Monthly = parseFloat((_this.packages.car.Monthly * currenyValue).toFixed(1));
                newPrices.car.yearly = parseFloat((_this.packages.car.yearly * currenyValue).toFixed(1));
